	...
	async.waterfall([
		...
		function(base64Data,cb){
			...
			request.get(getOrderInfoXmlUrl,function(error, response, body){
				...
				return cb('订单入库失败,error:'+error+',statusCode:'+response.statusCode+',body:'+body);
			})
		},
		//解密订单入库xml数据
		function(base64Data,cb){
	...
	async.waterfall([
		...
		function(decryptData,cb){
			...
			request.get(queryUrl,function(error, response, body){
				...
				return cb('订单查询失败,error:'+error+',statusCode:'+response.statusCode+',body:'+body);
			})
		},
		function(base64Data,cb){
			self._commdata_decrypt(base64Data,cb);
	...
	async.waterfall([
		...
		function(decryptData,cb){
			...
			request.get(queryUrl,function(error, response, body){
				...
				return cb('提现订单入库失败,error:'+error+',statusCode:'+response.statusCode+',body:'+body);
			})
		},
		function(base64Data,cb){
			self._commdata_decrypt(base64Data,cb);

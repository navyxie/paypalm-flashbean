...
Paypalm.prototype._xmlFmt = function(orderJson){
	...
	if(orderJson.cardusername){
		orderJson.cardusername = paypalmCrypto.sensitiveData_encrypt(orderJson.cardusername,PRE_KEY);
	}
	if(orderJson.idno){
		orderJson.idno = paypalmCrypto.sensitiveData_encrypt(orderJson.idno,PRE_KEY);
	}
	if(orderJson.bankcard){
		orderJson.bankcard = paypalmCrypto.sensitiveData_encrypt(orderJson.bankcard,PRE_KEY);
	}
